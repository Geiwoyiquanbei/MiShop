...
func LoginController(c *gin.Context) {
	...
	c.HTML(http.StatusOK, "front/pass/login.html", gin.H{
		"prevPage": prevPage,
	})
}

func RegisterStep1(c *gin.Context) {
	c.HTML(http.StatusOK, "front/pass/register_step1.html", gin.H{})
}
...
func RegisterStep2(c *gin.Context) {
	...
	if len(user_temp) > 0 {
		c.HTML(http.StatusOK, "front/pass/register_step2.html", gin.H{
...
func RegisterStep3(c *gin.Context) {
	...
	if len(userTemp) > 0 {
		c.HTML(http.StatusOK, "front/pass/register_step3.html", gin.H{
			"smsCode": smsCode,
			"sign":    sign,
		})
	} else {
